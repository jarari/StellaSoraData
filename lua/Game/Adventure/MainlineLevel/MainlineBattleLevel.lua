...
function MainlineBattleLevel:PrePorcessChestData(nMainlineId) --预处理DataTable的宝箱数据
    ...
    local function func_cbFinishSucc(_,mapMainData)
        ...
        local function func_AvgEnd()
            ...
            EventManager.Hit(EventId.OpenPanel, 
                            ...
                            true,
                            nLevelStar,
                            mapMainData.GenerRewardItems or {},
                            mapMainData.FirstRewardItems or {},
                            mapMainData.ChestRewardItems or {},
                            mapMainData.Exp or 0, 
                            false,
                            sLarge,
                            sSmall,
                            nMainlineId,
        ...
        if sAvgId then
            ...
            if PlayerData.Mainline.bUseOldMainline then
                self:PlaySuccessPerform(mapMainData.GenerRewardItems, mapMainData.FirstRewardItems, mapMainData.ChestRewardItems, 
                    mapMainData.Exp, nLevelStar, fadeT, mapMainData.Change)
            else
