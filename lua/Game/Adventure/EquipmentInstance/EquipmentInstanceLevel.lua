...
local mapEventConfig = {LoadLevelRefresh = "OnEvent_LoadLevelRefresh", [EventId.AbandonBattle] = "OnEvent_AbandonBattle", EquipmentInstanceGameEnd = "OnEvent_LevelResult", AdventureModuleEnter = "OnEvent_AdventureModuleEnter", BattlePause = "OnEvnet_Pause"}
EquipmentInstanceLevel.Init = function(self, parent, nLevelId, nBuildId)
...
EquipmentInstanceLevel.RefreshCharDamageData = function(self)
  -- function num : 0_1 , upvalues : _ENV
  self.tbCharDamage = (UTILS.GetCharDamageResult)(self.tbCharId)
end

EquipmentInstanceLevel.OnEvent_LoadLevelRefresh = function(self)
...
EquipmentInstanceLevel.OnEvent_LevelResult = function(self, tbStar, bAbandon)
  ...
  if ((((not tbStar[0] or not 1) and not tbStar[1])) or tbStar[2]) then
    ...
    local waitCallback = function()
      -- function num : 0_3_0_0 , upvalues : _ENV, nStar, self, tbFirstReward, tbStarReward, tbSurpriseItems, nExp, tbStar, mapChangeInfo
      (NovaAPI.InputEnable)()
      if nStar > 0 then
        ...
        local sLarge, sSmall = "", ""
        if not self.tbCharDamage then
          (EventManager.Hit)(EventId.OpenPanel, PanelId.EquipmentInstanceResult, false, tbStar, {}, {}, {}, 0, false, sLarge, sSmall, self.nLevelId, self.tbCharId, mapChangeInfo, {}, {})
          ;
...
EquipmentInstanceLevel.OnEvent_AbandonBattle = function(self)
  -- function num : 0_4
  self:OnEvent_LevelResult({false, false, false}, true)
end

EquipmentInstanceLevel.OnEvent_AdventureModuleEnter = function(self)
...
EquipmentInstanceLevel.BindEvent = function(self)
...
EquipmentInstanceLevel.UnBindEvent = function(self)
...
EquipmentInstanceLevel.PlaySuccessPerform = function(self, FirstRewardItems, tbStarReward, tbSurpriseItems, nExp, tbStar, mapChangeInfo)
  ...
  local openBattleResultPanel = function()
    -- function num : 0_8_2 , upvalues : _ENV, self, openBattleResultPanel, tbStar, tbStarReward, FirstRewardItems, nExp, mapChangeInfo, tbSurpriseItems
    (EventManager.Remove)("SettlementPerformLoadFinish", self, openBattleResultPanel)
    local sLarge, sSmall = "", ""
    if tbSurpriseItems or not self.tbCharDamage then
      (EventManager.Hit)(EventId.OpenPanel, PanelId.EquipmentInstanceResult, true, tbStar, {}, {}, {}, (tbStarReward or not FirstRewardItems) and nExp or 0, false, sLarge, sSmall, self.nLevelId, self.tbCharId, mapChangeInfo, {}, {})
      self.bSettle = false
      ;
      (self.parent):LevelEnd()
      self:UnBindEvent()
...
EquipmentInstanceLevel.SetCharFixedAttribute = function(self)
...
EquipmentInstanceLevel.CalCharFixedEffect = function(self, nCharId, bMainChar, tbDiscId)
...
EquipmentInstanceLevel.SetPersonalPerk = function(self)
...
EquipmentInstanceLevel.SetDiscInfo = function(self)
...
EquipmentInstanceLevel.OnEvnet_Pause = function(self)
