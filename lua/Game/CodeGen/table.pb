...
ItemNum (RItemNum"E
table_AcquireReward.
list (2.nova.client.AcquireRewardRlist"‘
Activity
Id (RId
...
table_ActivityGoods.
list (2.nova.client.ActivityGoodsRlist"ﬂ
...
table_ActivityGroup.
list (2.nova.client.ActivityGroupRlist"õ
ActivityLevelsFloor
Id (RId
...
list (2 .nova.client.ActivityShopControlRlist"à
ActivityTask
Id (RId
Title (	RTitle
Desc (	RDesc
...
Qty3 (RQty3"C
table_ActivityTask-
list (2.nova.client.ActivityTaskRlist"ô
ActivityTaskControl
...
list (2 .nova.client.ActivityTaskControlRlist"Ö
ActivityTaskGroup
Id (RId 
...
list (2.nova.client.AffinityUpRewardRlist"ü
Agent
Id (RId
Tab (RTab
Note (	RNote
...
table_AreaEffect+
list (2.nova.client.AreaEffectRlist"ø
	Attribute
Id (	RId
GroupId (RGroupId
Break (RBreak
...
DMGPLUSRCD"=
table_Attribute*
list (2.nova.client.AttributeRlist"j
AttributeLimit
Id (RId
Lower (RLower
Upper (RUpper
	IsLimited (R	IsLimited"G
table_AttributeLimit/
list (2.nova.client.AttributeLimitRlist"Ë
Banner
Id (RId
...
Param6	 (	RParam6"7
table_Banner'
list (2.nova.client.BannerRlist"∆
...
list (2.nova.client.BreakOutEnemySprRlist"È
...
list (2.nova.client.ChapterRlist"Ô
	Character
Id (RId
Name (	RName
Visible (RVisible
...
list (2$.nova.client.CharacterArchiveContentRlist"É
...
SmoothTime"E
table_CharacterSkin.
list (2.nova.client.CharacterSkinRlist"û
...
list (2!.nova.client.CharAffinityTemplateRlist"’
CharGem
Id (RId(
...
list (2.nova.client.CharGemRlist"î
CharGemAttrGroup
GroupId (RGroupId
	GroupType (R	GroupType0
UniqueAttrNumWeight (	RUniqueAttrNumWeight
Weight (RWeight"K
table_CharGemAttrGroup1
list (2.nova.client.CharGemAttrGroupRlist"W
CharGemAttrType
Id (RId
AttrType (	RAttrType
GroupId (RGroupId"I
table_CharGemAttrType0
list (2.nova.client.CharGemAttrTypeRlist"ú
CharGemAttrValue
Id (RId
TypeId (RTypeId
...
list (2 .nova.client.CharGemInstanceTypeRlist"Ë
CharGemSlotControl
Id (RId
Position (RPosition*
...
UnlockLevel (RUnlockLevel0
UniqueAttrGroupProb (RUniqueAttrGroupProb,
UniqueAttrGroupId	 (RUniqueAttrGroupId&
GuaranteeCount
 (RGuaranteeCount 
AttrGroupId (RAttrGroupId 
LockItemTid (RLockItemTid 
LockItemQty (RLockItemQty"O
...
BGM (	RBGM"E
table_CookieControl.
list (2.nova.client.CookieControlRlist"˘
CookieFloor
Id (RId
FloorId (RFloorId
...
table_GMTeam'
list (2.nova.client.GMTeamRlist"©
Guide
Id (RId
GroupId (RGroupId
Step (RStep
...
table_HtmlConfig+
list (2.nova.client.HtmlConfigRlist"˚
...
list (2&.nova.client.JointDrillBattleThresholdRlist"˝
JointDrillControl
Id (RId&
...
DetailDesc (	R
DetailDesc*
FastEntranceIcon (	RFastEntranceIcon"M
table_JointDrillControl2
list (2.nova.client.JointDrillControlRlist"ù
JointDrillFloor
Id (RId
FloorId (RFloorId
...
table_Mainline)
list (2.nova.client.MainlineRlist"É
...
Param7 (	RParam7"=
table_MainSkill*
list (2.nova.client.MainSkillRlist"ı
MallGem
Id (	RId
Name (	RName
Desc (	RDesc*
...
list (2#.nova.client.MiningDemoRewardConfigRlist"ˇ
MiningQuest
Id (RId
...
table_MiningQuest,
list (2.nova.client.MiningQuestRlist"è
MiningStory
Id (RId
...
list (2.nova.client.MiningTreasureRlist"Ô
Monster
Id (RId
Name (	RName
EpicLv (REpicLv(
...
RewardNum2"A
table_MonthlyCard,
list (2.nova.client.MonthlyCardRlist"ê
NPCAffinityGroup
Id (RId
Level (RLevel$
...
list (2$.nova.client.OnceAdditionalAttributeRlist"Ê
...
ParameterType2 (RParameterType2
Value2 (RValue2&
...
Param6 (	RParam6";
table_OpenFunc)
list (2.nova.client.OpenFuncRlist"µ
...
Icon
 (	RIcon"?
table_PlayerHead+
list (2.nova.client.PlayerHeadRlist"⁄
Plot
Id (RId
Char (RChar
Name (	RName
...
list (2.nova.client.ScoreBossControlRlist"Ê
ScoreBossFloor
Id (RId
	SceneName (	R	SceneName*
ConfigPrefabName (	RConfigPrefabName
...
list (2.nova.client.ScoreBossFloorRlist"â
ScoreBossGetControl
Id (RId,
ScoreBossBehavior (RScoreBossBehavior$
ScoreBossType (RScoreBossType
Name (	RName 
BehaviorDes (	RBehaviorDes
...
list (2'.nova.client.StarTowerBookFateCardQuestRlist"Ã
...
list (2!.nova.client.StarTowerGrowthGroupRlist"Ø
StarTowerGrowthNode
Id (RId
NodeId (RNodeId
Group (RGroup
...
list (2 .nova.client.StarTowerGrowthNodeRlist"ÿ
StarTowerMap
Id (RId
SceneRes (	RSceneRes
...
ChapterYear	 (	RChapterYear,
UnlockShowStoryId
 (RUnlockShowStoryId"C
table_StoryChapter-
...
list (2.nova.client.StoryPersonalityRlist"¯
...
list (2!.nova.client.StoryRolePersonalityRlist"√
StorySetChapter
Id (RId
OpenTime (	ROpenTime"
...
list (2.nova.client.StorySetSectionRlist"‘
SubNoteSkill
Id (RId
Scores (RScores
EffectId (REffectId
...
list (2.nova.client.TestCharacterAttRlist"#
TestCharacterList
Id (RId"M
...
table_TestTeamData-
list (2.nova.client.TestTeamDataRlist"u
Title
Id (RId
ItemId (RItemId
...
Sort (RSort"5
table_Title&
list (2.nova.client.TitleRlist"Ã
TopBar
Id (	RId
Title (	RTitle
EntryId (REntryId
...
InitPlayers
 (RInitPlayers"
UpgradeSpeed (RUpgradeSpeed
ItemID (RItemID
BGM (	RBGM,
LeaveTriggerEvent (	RLeaveTriggerEvent$
IntroCutscene (	RIntroCutscene"M
table_TowerDefenseFloor2
list (2.nova.client.TowerDefenseFloorRlist"ó
TowerDefenseGuide
Id (RId
...
list (2.nova.client.TowerDefenseItemRlist"À
TowerDefenseLevel
Id (RId
...
list (2 .nova.client.TowerDefenseTeamExpRlist"Í
Trap
Id (RId
Name (	RName
FCId (RFCId
...
list (2.nova.client.TravelerDuelBossRlist"Á
...
PreLevelStar (RPreLevelStar*
UnlockWorldClass (RUnlockWorldClass(
UnlockDuelLevel (RUnlockDuelLevel
DuelExp (RDuelExp*
BaseAwardPreview (	RBaseAwardPreview
Affinity (RAffinity
Icon (	RIcon
...
Cover (	RCover
SkinId (RSkinId*
ExtraDropPreview (RExtraDropPreview"U
table_TravelerDuelBossLevel6
list (2".nova.client.TravelerDuelBossLevelRlist"∆
...
SkillId (RSkillId
BranchId (RBranchId
LogicTag (	RLogicTag"_
 table_TravelerDuelChallengeAffix;
list (2'.nova.client.TravelerDuelChallengeAffixRlist"π
TravelerDuelChallengeDifficulty
Id (RId
Attr (RAttr
EffectId (REffectId&
RecommendScore (RRecommendScore.
RecommendBuildRank (RRecommendBuildRank"i
%table_TravelerDuelChallengeDifficulty@
list (2,.nova.client.TravelerDuelChallengeDifficultyRlist"¸
...
list (2'.nova.client.TravelerDuelChallengeQuestRlist"≥
TravelerDuelChallengeRankReward
Id (RId
	RankUpper (R	RankUpper$
...
%table_TravelerDuelChallengeRankReward@
list (2,.nova.client.TravelerDuelChallengeRankRewardRlist"Ò
...
OpenTime (	ROpenTime
EndTime (	REndTime"a
!table_TravelerDuelChallengeSeason<
list (2(.nova.client.TravelerDuelChallengeSeasonRlist"á
TravelerDuelFloor
Id (RId
	SceneName (	R	SceneName*
ConfigPrefabName (	RConfigPrefabName
...
list (2.nova.client.TravelerDuelFloorRlist"o
TravelerDuelLevel
Id (RId

LevelUpExp (R
LevelUpExp*
CoinAdditionProb (RCoinAdditionProb"M
table_TravelerDuelLevel2
list (2.nova.client.TravelerDuelLevelRlist"Ÿ
TravelerDuelQuest
Id (RId
Title (	RTitle
Desc (	RDesc
...
table_TravelerDuelQuest2
list (2.nova.client.TravelerDuelQuestRlist"–
...
BossBg (	RBossBg"C
table_WeekBossType-
list (2.nova.client.WeekBossTypeRlist"Y
WeightParameter
id (Rid
