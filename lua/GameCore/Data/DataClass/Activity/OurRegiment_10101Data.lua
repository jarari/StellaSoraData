...
OurRegiment_10101Data.Init = function(self)
  -- function num : 0_0
  self.tbAllActivity = {}
...
OurRegiment_10101Data.ParseActivity = function(self)
...
OurRegiment_10101Data.GetActivityDataByIndex = function(self, nIndex)
...
OurRegiment_10101Data.PlayCG = function(self)
  -- function num : 0_3
  self:SendMsg_CG_READ(self.nCGActivityId)
end

OurRegiment_10101Data.GetActivityGroupCGPlayed = function(self)
...
OurRegiment_10101Data.IsActivityInActivityGroup = function(self, nActivityId)
...
OurRegiment_10101Data.SendMsg_CG_READ = function(self, nActivityId)
